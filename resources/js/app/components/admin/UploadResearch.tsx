        ...
        <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 bg-[#F5F3FF] border border-purple-200 rounded-xl">
                ...
                <p className="text-xs text-purple-800">
                    ...
                    fields here. After the PDF is securely stored, gemma2:2b runs separately and never
    ...
    return (
        <div className="p-6 sm:p-8 space-y-6">
            <FormSectionHeader
                ...
                total={total}
                accentColor="#7C3AED"
                subtitle="Prepare the initial editable fields. gemma2:2b suggestions become available after the draft and source PDF are securely stored."
            />
            ...
            {!analyzing && !ready && (
                <div className="flex flex-col items-center justify-center py-14 space-y-5">
                    ...
                    <div className="text-center max-w-sm">
                        ...
                        <p className="text-sm text-gray-500">
                            Continue to an editable metadata draft. Real gemma2:2b analysis runs after the
                            source PDF is stored and remains subject to human review.
                        </p>
                    </div>
                    <button
                    ...
                    <div className="flex items-center gap-3 p-3.5 bg-green-50 border border-green-200 rounded-xl">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-green-600">
                                These fields are human-controlled. Review the separate gemma2:2b suggestions
